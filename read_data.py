...
def load_mnist(dataset="training", digits=np.arange(10), path=".", no_of_imgs=60000):
    ...
    images = np.zeros((no_of_imgs, img_nx, img_ny), dtype=np.uint8)
...
def load_fashion_mnist(dataset="training", digits=np.arange(10), path=".", no_of_imgs=60000):
    if dataset == "training":
        fname_img = os.path.join(path, 'train-images-id5k-ubyte')
        fname_lbl = os.path.join(path, 'train-labels-id5k-ubyte')
    # elif dataset == "testing":
        # fname_img = os.path.join(path, 't10k-images.idx3-ubyte')
        # fname_lbl = os.path.join(path, 't10k-labels.idx1-ubyte')
